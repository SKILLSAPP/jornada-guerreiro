        ...
        <div className="relative min-h-screen flex flex-col" style={{ background: 'black' }}>
            ...
            <div className="relative flex-grow flex flex-col overflow-y-auto">
                <div className="w-full flex-grow flex flex-col justify-between">
                    ...
                    <div className="flex-grow flex items-center justify-center p-4 md:justify-end">
                        <div className="w-full max-w-lg md:max-w-md text-center md:text-right mt-20 md:mr-8 lg:mr-16">
                    ...
                    <div className="w-full bg-black/80 p-6 backdrop-blur-sm mt-8">
            ...
            <div className="absolute top-4 left-4 sm:top-6 sm:left-6 z-20">
                <button onClick={onBackToMap} className="text-yellow-400 hover:text-yellow-300 font-semibold text-lg bg-black/50 px-4 py-2 rounded-lg backdrop-blur-sm border border-white/20">
                    &larr; Voltar
                </button>
            </div>
        </div>
