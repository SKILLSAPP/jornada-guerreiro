    ...
    <div className="flex items-center justify-center min-h-screen">
      <div className="w-full max-w-md p-8 space-y-8 bg-gray-800 bg-opacity-80 rounded-2xl shadow-2xl border border-yellow-500/30">
        <div className="text-center">
          <h1 className="text-4xl font-bold font-cinzel text-yellow-400 tracking-wider">As Dez Ilhas Sagradas</h1>
          <p className="mt-2 text-gray-300">A Jornada de um Guerreiro Começa</p>
        </div>
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
         ...
         <p className="pt-4 text-center text-xs text-gray-500">
          Sua conta de guerreiro deve ser criada pelo Mestre.
        </p>
      </div>
    </div>
  );
